...
enum EMonsterType : int
{
    ...
    MONSTER_CURSED_KNIGHT_BOSS = 669,
    MONSTER_CURSED_WIZARD_BOSS = 670,
    MONSTER_CURSED_ELF_BOSS = 671,
    MONSTER_CURSED_LORD_BOSS = 672,
    MONSTER_CURSED_GLADIATOR_BOSS = 673,
    MONSTER_CURSED_SUMMONER_BOSS = 674,
    MONSTER_CURSED_FIGHTER_BOSS = 675,
